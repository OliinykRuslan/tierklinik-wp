...
?>
    ...
    <section class="section-hero">
        <div class="hero-wrap"
             style="background: url(<?= get_template_directory_uri() . '/dist/assets/images/hero-bg-scale.jpg' ?>)">
...
?>
    ...
    <section class="news-section vacancy">
        ...
        <a href="/offene-stellen" class="btn shadow-lg mx-auto more"><?= __('Alle Stellen anzeigen') ?></a>
    </section>


    <a href="/medizinische-anweisungen" class="btn full-btn bg-green">
